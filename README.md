...
- 推荐使用 OpenClaw `2026.3.28` 或更新版本。
- 已核查 OpenClaw `2026.3.28`、`2026.3.31`、`2026.4.1`、`2026.4.14`、`2026.5.27` 所需插件 SDK 接口。
- OpenClaw `2026.3.24` 及更早版本缺少当前实现依赖的部分插件 SDK 接口，不建议使用。
